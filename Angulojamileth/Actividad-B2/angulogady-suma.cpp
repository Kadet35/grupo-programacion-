...
{
        int AG_C=0,AG_a;                                           float AG_S=0,AG_Z;
        cout<<"Ingrese cantidad de numeros a sumar: ";
        cin>>AG_a;
        do{
                cout<<"Ingrese un numero: ";
                cin>>AG_Z;
                AG_C=AG_C+1;                                               AG_S=AG_S+AG_Z;                                    }while(AG_C<AG_a);                                         cout<<"//=======Nombre de programa: Suma de dos numeros"<<endl;                                                       cout<<"//====Archivo:Angulojamileth-SumaN.cpp"<<endl;

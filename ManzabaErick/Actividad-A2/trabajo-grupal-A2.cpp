...
cout<<"ingrese fecha actual:  dia mes a�o";
cin>>d>>m>>a;
cout<<"ingre su fecha de nacimiento: dia mes a�o";
cin>>d1>>m1>>a1;
if(d<d1)
{ d=d+30;
  m=m-1;
...
a2=a-a1;
cout<<"Usted tiene: "<<a2<<" a�os "<<m2<<"meses "<<"y "<<d2<<"dia "<<endl;
return 0;	
		break;
...
kb_d2=kb_d-kb_d1;
   ...
   kb_m2=kb_m-kb_m1;
    ...
    kb_a2=kb_a-kb_a1;
    cout<<"Usted�tiene:�"<<kb_a2<<"�a�os�"<<kb_m2<<"meses�"<<"y�"<<kb_d2<<"dia�"<<endl;
		break;
		case 6:   	cout<<"LIMPIAR PANTALLA"; system("cls");
		break;
		default: cout<<"OPCION INCORRECTA LEE BIEN Y VUELVE A INTENTARLO QUE SI PUEDES\n"; break;
